...
#define PARM_OUT L"-out:"				// ключ для файла обьектного кода
#define PARM_LOG L"-log:"				// ключ для файла журнала
#define PARM_MAX_SIZE 300				// макс длина строки параметра
#define PARM_OUT_DEFAULT_EXT L".out"	// расширение файла обьектного кода по умолчанию
...
namespace Parm		// обработка входных параметров
{
	struct PARM		// входные параметры
	{
		...
		wchar_t out[PARM_MAX_SIZE]; // имя файла обьектного кода
